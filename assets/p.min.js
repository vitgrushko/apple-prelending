function stepfinal() {
  jQuery(".box-gift").fadeOut("slow"), jQuery("#p_body_content").fadeIn("slow");
...
/*----------------------Output of answers------------------------*/
document
  .querySelectorAll(".question__item button")
...
document.getElementById("comment__add").onclick = function () {
  ...
  let commentBody = document.getElementById("comment__body");
...
function showComments() {
  let commentArea = document.getElementById("comment__area");
  let out = "";
  comments.forEach(function (el) {
    out += `<div class="comments" id="comment0" style="display: block">
    <div class="profile">
